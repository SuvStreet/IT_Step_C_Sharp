...
[**<-- Введение в классы**](https://github.com/SuvStreet/IT_Step_C_Sharp/tree/master/ClassWork/Day4#Введение-в-классы) `=/=` [**Перегрузка операторов -->**](https://github.com/SuvStreet/IT_Step_C_Sharp/tree/master/ClassWork/Day6#Перегрузка-операторов)
